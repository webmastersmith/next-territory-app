export const HomeWorkIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M17 7h2v2h-2zm0 4h2v2h-2zm0 4h2v2h-2zM1 11v10h6v-5h2v5h6V11L8 6l-7 5zm12 8h-2v-5H5v5H3v-7l5-3.5l5 3.5v7z"></path>
      <path fill="currentColor" d="M10 3v1.97l2 1.43V5h9v14h-4v2h6V3z"></path>
    </svg>
  )
}
...
export const UploadSvg: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      width="1em"
      height="1em"
      ...
      {...props}
    >
      <path d="M19.35 10.04A7.49 7.49 0 0 0 12 4C9.11 4 6.6 5.64 5.35 8.04A5.994 5.994 0 0 0 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5c0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l5-5l5 5h-3z"></path>
    </svg>
  )
}
